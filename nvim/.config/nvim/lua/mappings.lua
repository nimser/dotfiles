...
M.set_telescope_mappings = function()
  ...
  end, {desc="Browse (hidden) files and folders from cwd, including gitignored ones"})
  ...
  map('n', '<leader>fbn', function()
    telescope.extensions.file_browser.file_browser({files=true, hidden=true, respect_gitignore=false})
  end, {desc="Browse (hidden) neovim files, including gitignored ones"})
  ...
  map('n', '<leader>fc', function()
    telescope_builtin.find_files({cwd='~/code', hidden=true})
  end, {desc="Search all (hidden) files in ~/code"})
  map('n', '<leader>fbc', function()
    telescope.extensions.file_browser.file_browser({cwd='~/code', hidden=true, respect_gitignore=false})
  end, {desc="Browse anything (hidden) from ~/code"})
